...
public class TodosLosCochesActivity extends ToolbarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.todos_los_coches_layout);
    ...
    private void cargarCoches() {
        List<Coche> coches = cocheDAO.listarTodosLosCoches();
